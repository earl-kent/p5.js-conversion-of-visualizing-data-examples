...
let coffee_selected_png, coffee_unselected_png, milk_selected_png,
    milk_unselected_png, tea_selected_png, tea_unselected_png;
...
function preload() {
  ...
  coffee_selected_png = loadImage("data/Coffee-selected.png");
  coffee_unselected_png = loadImage("data/Coffee-unselected.png");
  milk_selected_png = loadImage("data/Milk-selected.png");
  milk_unselected_png = loadImage("data/Milk-unselected.png");
  tea_selected_png = loadImage("data/Tea-selected.png");
  tea_unselected_png = loadImage("data/Tea-unselected.png");
}


function setup() {
  selected["Milk"] = milk_selected_png;
  unselected["Milk"] = milk_unselected_png;
  selected["Coffee"] = coffee_selected_png;
  unselected["Coffee"] = coffee_unselected_png;
  selected["Tea"] = tea_selected_png;
  unselected["Tea"] = tea_unselected_png;
...
function drawTitleTabs() {
  ...
  if (tabLeft === undefined) {
    ...
    tabImageNormal = new Array(columnCount);
    tabImageHighlight = new Array(columnCount);
    for (let col = 0; col < columnCount; col++) {
      let title = data.getColumnName(col);
      tabImageNormal[col] = unselected[title];
      tabImageHighlight[col] = selected[title];
    }
  }
